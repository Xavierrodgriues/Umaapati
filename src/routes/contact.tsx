...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Umaapati International Business LLP" },
      { name: "description", content: "Get in touch with Umaapati International Business LLP for customs, freight, EXIM consultancy and logistics support." },
      { property: "og:title", content: "Contact Umaapati International Business LLP" },
      { property: "og:description", content: "Speak with Deepanshu Jharodia — +91 90290 79890" },
    ],
  }),
  component: Contact,
});
